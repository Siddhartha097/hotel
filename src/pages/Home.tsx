    ...
    <main className="w-full h-full mb-10">
        ...
        <div className=" flex pt-2 items-center justify-between space-x-6">
          <Carousel>
            <CarouselContent className="cursor-grab">
              <Options name="Our Rooms" img={bedroom} />
              <Options name="Dinning" img={cafe} />
              <Options name="Offers" img={hall} />
              <Options name="Gallery" img={hotel} />
            </CarouselContent>
          </Carousel>
        </div>
      </div>
      ...
      <div className="md:flex-row px-6 md:px-10 gap-10 flex flex-col items-center justify-between mt-5">
        <div className="flex flex-col">
          <h3 className="text-2xl md:text-3xl lg:text-5xl island text-yellow-700">
            About Us
          </h3>
          <h1 className=" island text-yellow-700 text-4xl md:text-6xl lg:text-8xl">
            PrecisionHub{" "}
            <span className="inter text-black lg:text-4xl font-semibold">
              {" "}
              Hotel
            </span>
          </h1>
          <p className="text-sm tracking-wide inria font-medium">
            Discover a realm of opulence and refinement at Luxe Haven Retreat,
            where we redefine the art of hospitality. Nestled in the heart of
            [City], our hotel is a sanctuary of timeless elegance and
            contemporary comfort, designed to captivate the senses and elevate
            your stay to unparalleled heights. <br />
            A Symphony of Luxury: Step into a world where luxury isn't just a
            word; it's an experience woven into every thread of our exquisite
            interiors. From the moment you enter our grand lobby adorned with
            crystal chandeliers to the sumptuous comfort of your meticulously
            appointed room, you'll find a seamless fusion of style and
            sophistication. <br />
            Unrivaled Comfort: Indulge in a night of unparalleled comfort in our
            plush, king-sized beds adorned with premium linens. Each room is a
            haven of tranquility, featuring state-of-the-art amenities,
            complimentary Wi-Fi, and panoramic views of the city skyline or our
            lush garden oasis. <br />
            Gastronomic Delights: Savor the culinary masterpieces crafted by our
            award-winning chefs. Whether you're dining in our elegant
            restaurant, enjoying cocktails at the rooftop bar with panoramic
            city views, or indulging in room service, every bite is a journey
            through flavors that tantalize the taste buds.
          </p>
        </div>
      ...
      <div className="flex gap-6 flex-col md:flex-row items-center justify-center w-full h-full px-6 mt-10 md:px-10">
        ...
        <section>
          <Carousel>
            <CarouselContent>
              <Features img={bar} label="Restuarent & Bar" />
              <Features img={drinks} label="24Hrs Room Services" />
              <Features img={spa} label="Fitness & Spa" />
            </CarouselContent>
          </Carousel>
        </section>
      </div>
      ...
      <div className="flex gap-6 flex-col-reverse md:flex-row items-center justify-center w-full h-full px-6 mt-10 md:px-10">
        <section className="flex flex-col-reverse gap-5 md:flex-col">
          <Button className="text-xl w-fit px-8 py-6 bg-[#B26C02] text-black inria font-semibold hover:bg-neutral-400">
            View All Rooms
          </Button>
          <Carousel>
            <CarouselContent>
              <Rooms price={25} img={room1} name="President Suite" />
              <Rooms price={20} img={room2} name="Single BedRoom" />
              <Rooms price={19} img={room3} name="Double BedRoom" />
              <Rooms price={35} img={room4} name="Twin BedRoom" />
            </CarouselContent>
          </Carousel>
        </section>
      ...
      <div className="flex gap-6 flex-col inria items-center justify-center w-full h-full px-6 mt-10 md:px-10">
        <h1 className="text-4xl lg:text-5xl text-[#B26C02] font-bold">
          Food Court
        </h1>
        <p className="text-center text-sm ">
          Discover a realm of opulence and refinement at Luxe Haven Retreat,
          where we redefine the art of hospitality. Nestled in the heart of
          [City], our hotel is a sanctuary of timeless elegance and contemporary
          comfort, designed to captivate the senses and elevate your stay to
          unparalleled heights. A Symphony of Luxury: Step into a world where
          luxury isn't just a word; it's an experience woven into every thread
          of our exquisite interiors. From the moment you enter our grand lobby
          adorned with crystal chandeliers to the sumptuous comfort of your
          meticulously appointed room, you'll find a seamless fusion of style
          and sophistication.
        </p>
      </div>
      ...
      <div className="flex flex-col inria px-6 mt-10 md:px-10 w-full md:flex-row">
        ...
        <div className="relative w-full h-full">
          <div
            className={`absolute  max-md:relative flex-col flex p-10 max-md:p-6 items-center space-y-6 justify-center bg-black/50 max-md:bg-black h-full w-full z-10`}
          >
            <h1 className="text-3xl max-md:text-2xl text-[#B22D02] font-semibold">
              Our Restuarent Menu
            </h1>
            <p className="text-white text-sm text-center">
              Discover a realm of opulence and refinement at Luxe Haven Retreat,
              where we redefine the art of hospitality. Nestled in the heart of
              [City], our hotel is a sanctuary of timeless elegance and heights.
            </p>
      ...
      <div className="flex justify-center flex-col-reverse py-6 md:py-10 lg:py-12 max-md:gap-7 md:space-x-8 inria px-6 mt-10 md:px-10 w-full md:flex-row">
        ...
        <section className="bg-[#000000A8] max-md:w-full w-1/3 rounded-lg py-10 max-md:py-6 px-10 max-md:px-6">
          <div className="text-center">
            <h1 className="text-white text-5xl inria">
              Explore the Tourism Spot Near By{" "}
            </h1>
        ...
        <section className="shadow-md rounded-lg flex flex-col items-center justify-center w-1/3 max-md:w-full max-md:h-full">
          ...
          <iframe
            ...
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d117925.33439927742!2d88.34735275!3d22.53542735!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39f882db4908f667%3A0x43e330e68f6c2cbc!2sKolkata%2C%20West%20Bengal!5e0!3m2!1sen!2sin!4v1708414039665!5m2!1sen!2sin"
            width="600"
            height="450"
            allowFullScreen
            loading="lazy"
